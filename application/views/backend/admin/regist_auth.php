...
<head>
   ...
   <title>Register Admin | Aplikasi Peminjaman Alat</title>
...
<body class="hold-transition login-page masthead-login">
   <div class="login-box">
      <div class="login-logo">
         <a class="text-header">Register <b>Admin</b></a>
      </div>
      <!-- /.login-logo -->
      <div class="login-box-body">
         ...
         <form method="post" action="<?= base_url('auth/register_admin'); ?>">
            ...
            <fieldset>
               ...
               <div class="row">
                  <div class="col-xs-4">
                     <a class="btn btn-secondary btn-block btn-flat" href="<?php echo base_url('admin') ?>">Batal</a>
                  </div>
                  <!-- /.col -->
                  <div class="col-xs-4">
