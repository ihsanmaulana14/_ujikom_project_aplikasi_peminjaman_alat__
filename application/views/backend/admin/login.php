...
<head>
   ...
   <title>Login Admin | Aplikasi Peminjaman Alat</title>
...
<body class="hold-transition login-page masthead-login">
   <div class="login-box">
      <div class="login-logo">
         <a class="text-header">Login <b>Admin</b></a>
      </div>
      <!-- /.login-logo -->
      <div class="login-box-body">
         ...
         <a href="<?= base_url('auth/register_admin') ?>" class="text-center">Belum punya akun? Buat akun</a>
