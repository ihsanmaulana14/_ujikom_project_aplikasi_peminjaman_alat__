...
<div class="panel panel-default">
   ...
   <form class="form-horizontal" method="POST" id="peminjam_form" action="<?php if ($data != null) echo base_url('member_system/edit_profile_update');
      ...
      <div class="panel-body">
         ...
         <div class="form-group">
            ...
            <div class="col-md-3 col-xs-12">
               <input type="text" name="password" class="form-control" value="<?php if ($data != null) echo $this->encrypt->decode($data->password); ?>" disabled>
            </div>
         </div>
         <div class="form-group">
