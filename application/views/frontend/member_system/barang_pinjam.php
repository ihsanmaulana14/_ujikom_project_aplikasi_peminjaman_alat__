<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Form Pinjam Alat</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Form Pinjam Alat</h3>
	</div>
	<form class="form-horizontal" method="POST" id="barang_pinjam" action="<?php echo base_url('member_system/barang_pinjam_act'); ?>">
		...
		<div class="panel-body">
			...
			<div class="alert alert-warning hidden"><strong>Memproses! </strong><span>Mohon tunggu, system sedang
					bekerja.</span></div>
			...
			<div class="form-group">
				...
				<input type="hidden" class="form-control" value="<?php echo $data->id_barang; ?>" disabled>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-4 col-xs-12 control-label">Kode Alat</label>
			<div class="col-md-2 col-xs-12">
				<input type="text" name="" class="form-control" value="<?php echo $data->kode_alat; ?>" disabled>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-2 col-xs-12">
				<input type="text" name="" class="form-control" value="<?php echo $data->satuan; ?>" disabled>
			</div>
		</div>
		<div class="form-group">
