...
<head>
    ...
    <title>Login Peminjam | Aplikasi Peminjaman Alat</title>
...
<body class="hold-transition login-page masthead-login">
    <div class="login-box">
        <div class="login-logo">
            <a class="text-header">Login <b>Peminjam</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Log In to start your session</p>

            <form action="<?= base_url('member/do_login'); ?>" method="post" role="form" id="login_form">
                ...
                <fieldset>
                    <div class="form-group has-feedback">
                        <input type="text" name="email" class="form-control" placeholder="email address" value="<?= set_value('email') ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <a class="btn btn-secondary btn-block btn-flat" href="<?php echo base_url('admin/batal') ?>">Batal</a>
                        </div>
                        <!-- /.col -->
                        <div class="col-xs-4">
            ...
            <a href="<?= base_url('auth/register') ?>" class="text-center">Belum punya akun? Buat akun</a>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 'ok') {
                            $('#login-form .alert-success').removeClass('hidden').children(
                                'span').text(response.msg);
                            window.location.href = response.redirect;
                        }
                        // $('#login-form .alert-danger').removeClass('hidden').children(
                        //     'span').text(response.msg);
                    },
